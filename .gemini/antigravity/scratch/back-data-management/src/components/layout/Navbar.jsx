...
export default function Navbar() {
    ...
    return (
        <nav className="bg-primary-500 text-white shadow-lg fixed top-0 left-0 right-0 z-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    <div className="flex items-center gap-4">
                        <div className="flex items-center bg-primary-600/50 rounded px-1.5 py-0.5">
                            <select
                                value={selectedYear}
                    ...
                    <div className="flex items-center">
                        <span className="mr-4 text-sm text-white">{user.name}님</span>
                        <button
                            onClick={handleLogout}
                            className="p-1 rounded-full text-white hover:bg-primary-600 focus:outline-none"
                            title="로그아웃"
                        >
