...
export default function UserProfile() {
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6">
            {/* Top Bar with Messages and Save Button */}
            <div className="flex justify-between items-center">
                <div className="flex-1">
                    {error && <div className="text-red-500 text-sm font-medium bg-red-50 px-3 py-2 rounded inline-block border border-red-100">{error}</div>}
                    {message && <div className="text-green-600 text-sm font-medium bg-green-50 px-3 py-2 rounded inline-block border border-green-100">{message}</div>}
                </div>
            ...
            <div className="bg-white p-0 rounded-xl shadow-md border border-gray-100 overflow-hidden">
                <div className="bg-primary-500 p-2 border-b border-primary-600 flex justify-between items-center">
                    <h2 className="text-sm font-bold text-white pl-3">회원정보</h2>
                </div>
                <div className="p-6">
